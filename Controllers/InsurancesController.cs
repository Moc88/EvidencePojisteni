...
namespace EvidencePojisteni.Controllers
{
    public class InsurancesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,KlientId,Typ,Predmet,PlatnostOd,PlatnostDo,MesicniCastka")] Insurance insurance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,KlientId,Typ,Predmet,PlatnostOd,PlatnostDo,MesicniCastka")] Insurance insurance)
        {
            if (id != insurance.Id)
            {
                return NotFound();
